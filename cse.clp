(defrule cse
(user_domain CSE | cse | 2)
=>(section) (print "Welcome to Computer Science Domain!")
(section)
    (print "1.Operating Systems ")
        (print " This is the field of study where in we'll study many techinques and algorithms to study how to handle computer programs efficiently. " )
        (print crlf)
    (print "2. Artificial Intelligence ")
        (print "Artificial intelligence is the simulation of human intelligence processes by machines. Machine Learning is a subset of artificial intelligence")
        (print crlf)
    (print "3. Computer Architecture")
        (print "This field teaches you how a computer is built an it's architecture. Based on digitial logic")
        (print crlf)
    (print "4. DataStructures and Algorithms")
        (print "Data structures and algorithms are a critical part of a computer science education. A data structure is a method of organizing data in a virtual system.")
        (print "An algorithm is a sequence of steps executed by a computer that takes an input and transforms it into a target output.Together, data structures and algorithms combine and allow programmers to build great structures")
        (print crlf)
    (print "5. OOPS")
        (print "Object-oriented programming is a programming paradigm built on the concept of objects that contain both data and code to modify the data.Object-oriented programming mimics a lot of the real-world attributes of objects.")
        (print crlf)
